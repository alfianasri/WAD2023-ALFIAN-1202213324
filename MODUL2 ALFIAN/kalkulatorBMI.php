...
// silakan taruh code kalian di bawah
    if (isset($_POST['tinggi_badan']) && isset($_POST['berat_badan'])) {
        $tinggi_cm = $_POST['tinggi_badan'];
        $berat_kg = $_POST['berat_badan'];
    }
// **********************  1  ************************** 
...
// silakan taruh code kalian di bawah
    if ($tinggi_cm == null || $berat_kg = null) {
        $error_message = "Tinggi badan dan berat badan tidak boleh kosongyaa.";
    }
...
// silakan taruh code kalian di bawah
    if (!isset($error_message)) {
        ...
        $bmi = number_format($bmi, 2); // Membulatkan BMI ke 2 desimal
        if ($bmi < 18.5) {
            $status = "Underweight";
        } elseif ($bmi < 24.9) {
            $status = "Normal";
